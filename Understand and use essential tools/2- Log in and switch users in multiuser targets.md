...
`run` a `command` with the `user` `previlages`:

```bash
[bob@centos-host ~]$ su user -c "whoami"
Password:
...
for example, user Ali has only permission to user shutdown command:



```bash
Ali localhost=/usr/bin/shutdown -r now
```
...
```bash
Ali ALL=(ALL:ALL) /use/bin/apt,/usr/bin/rm
```
________________________________________________________________________________________________
...
```bash
Ali ALL=(ALL:ALL) NOPASSWD: /usr/bin/apt,/usr/bin/rm
```
________________________________________________________________________________________________
...
```bash
Ali	ALL = NOPASSWD: /usr/bin/updatedb, PASSWD: /bin/kill
```
________________________________________________________________________________________________
